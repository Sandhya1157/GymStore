                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="limiter">
                                    ...
                                    <input min="1" id="qty_<?php echo $info[0];?>" type="number" value="<?php echo $info[3];?>">
                            ...
                            <table id="shopping-cart-totals-table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <span class="price"><?php if(isset($_SESSION['shopping_cart'])) echo count($_SESSION['shopping_cart']);?></span>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right"><span class="price">Rs.&nbsp;<?php echo 0.13 * $subtotal; ?></span></td>
                                    </tr>
                                    <tr>
                                        <td class="text-left">Total</td>
                                        <td class="text-right"><span class="price">Rs.&nbsp;<?php echo 1.13 * $subtotal; ?></span></td>
                                    </tr>
                                </tbody>
                            </table>
